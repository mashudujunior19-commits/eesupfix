alter table "communities"."eesupool" drop constraint "eesupool_parent_id_fkey";
...
drop trigger if exists "on_unverified_prevent_wealth_wallet_txn_confirmations_trigger" on "finances"."transaction";

drop function if exists "finances"."on_unverified_prevent_wealth_wallet_txn_confirmations"();
...
alter table "inventory"."product_request" drop constraint "product_request_product_id_fkey";
...
drop trigger if exists "on_profile_verified_update_confirm_wealth_txns_trigger" on "public"."profile";

alter table "public"."basket_product" drop constraint "basket_product_product_id_fkey";

drop function if exists "public"."on_profile_verified_update_confirm_wealth_txns"();
...
alter table "sales"."order_product" drop constraint "order_product_product_id_fkey";
