drop policy "Enable access for authenticated users only" on "communities"."member_order_assigment";

create type "sales"."order_edit_privilage" as enum ('Packer', 'Collector', 'Owner', 'All');

revoke delete on table "communities"."member_order_assigment" from "anon";

revoke insert on table "communities"."member_order_assigment" from "anon";

revoke references on table "communities"."member_order_assigment" from "anon";

revoke select on table "communities"."member_order_assigment" from "anon";

revoke trigger on table "communities"."member_order_assigment" from "anon";

revoke truncate on table "communities"."member_order_assigment" from "anon";

revoke update on table "communities"."member_order_assigment" from "anon";

revoke delete on table "communities"."member_order_assigment" from "authenticated";

revoke insert on table "communities"."member_order_assigment" from "authenticated";

revoke references on table "communities"."member_order_assigment" from "authenticated";

revoke select on table "communities"."member_order_assigment" from "authenticated";

revoke trigger on table "communities"."member_order_assigment" from "authenticated";

revoke truncate on table "communities"."member_order_assigment" from "authenticated";

revoke update on table "communities"."member_order_assigment" from "authenticated";

revoke delete on table "communities"."member_order_assigment" from "service_role";

revoke insert on table "communities"."member_order_assigment" from "service_role";

revoke references on table "communities"."member_order_assigment" from "service_role";

revoke select on table "communities"."member_order_assigment" from "service_role";

revoke trigger on table "communities"."member_order_assigment" from "service_role";

revoke truncate on table "communities"."member_order_assigment" from "service_role";

revoke update on table "communities"."member_order_assigment" from "service_role";

alter table "communities"."member_order_assigment" drop constraint "member_order_assigment_collector_fkey";

alter table "communities"."member_order_assigment" drop constraint "member_order_assigment_order_id_fkey";

alter table "communities"."member_order_assigment" drop constraint "member_order_assigment_packer_fkey";

alter table "communities"."member_order_assigment" drop constraint "member_order_pkey";

drop index if exists "communities"."member_order_pkey";

drop table "communities"."member_order_assigment";

create table "communities"."member_order_assignment" (
    "order_id" integer not null,
    "eesupool_ord_id" integer not null,
    "member_id" uuid not null,
    "privilage" sales.order_edit_privilage not null default 'All'::sales.order_edit_privilage
);


alter table "communities"."member_order_assignment" enable row level security;

alter table "communities"."message" alter column "author_id" drop not null;

CREATE UNIQUE INDEX member_order_assignment_pkey ON communities.member_order_assignment USING btree (order_id, eesupool_ord_id, member_id);

alter table "communities"."member_order_assignment" add constraint "member_order_assignment_pkey" PRIMARY KEY using index "member_order_assignment_pkey";

alter table "communities"."member_order_assignment" add constraint "member_order_assignment_eesupool_ord_id_fkey" FOREIGN KEY (eesupool_ord_id) REFERENCES communities.eesupool_order(id) ON DELETE CASCADE not valid;

alter table "communities"."member_order_assignment" validate constraint "member_order_assignment_eesupool_ord_id_fkey";

alter table "communities"."member_order_assignment" add constraint "member_order_assignment_member_id_fkey" FOREIGN KEY (member_id) REFERENCES communities.eesupool_member(id) ON DELETE CASCADE not valid;

alter table "communities"."member_order_assignment" validate constraint "member_order_assignment_member_id_fkey";

alter table "communities"."member_order_assignment" add constraint "member_order_assignment_order_id_fkey" FOREIGN KEY (order_id) REFERENCES sales."order"(id) ON DELETE CASCADE not valid;

alter table "communities"."member_order_assignment" validate constraint "member_order_assignment_order_id_fkey";
...
grant delete on table "communities"."member_order_assignment" to "anon";

grant insert on table "communities"."member_order_assignment" to "anon";

grant references on table "communities"."member_order_assignment" to "anon";

grant select on table "communities"."member_order_assignment" to "anon";

grant trigger on table "communities"."member_order_assignment" to "anon";

grant truncate on table "communities"."member_order_assignment" to "anon";

grant update on table "communities"."member_order_assignment" to "anon";

grant delete on table "communities"."member_order_assignment" to "authenticated";

grant insert on table "communities"."member_order_assignment" to "authenticated";

grant references on table "communities"."member_order_assignment" to "authenticated";

grant select on table "communities"."member_order_assignment" to "authenticated";

grant trigger on table "communities"."member_order_assignment" to "authenticated";

grant truncate on table "communities"."member_order_assignment" to "authenticated";

grant update on table "communities"."member_order_assignment" to "authenticated";

grant delete on table "communities"."member_order_assignment" to "service_role";

grant insert on table "communities"."member_order_assignment" to "service_role";

grant references on table "communities"."member_order_assignment" to "service_role";

grant select on table "communities"."member_order_assignment" to "service_role";

grant trigger on table "communities"."member_order_assignment" to "service_role";

grant truncate on table "communities"."member_order_assignment" to "service_role";

grant update on table "communities"."member_order_assignment" to "service_role";

create policy "Enable access for authenticated users only"
on "communities"."member_order_assignment"
as permissive
for all
to authenticated
using (true)
...
drop function if exists "engagements"."send_push_notication"(title text, body text, campaign text, image_url text, data jsonb, recipients uuid[]);

alter table "engagements"."response" drop constraint "response_pkey";

drop index if exists "engagements"."response_pkey";

create table "engagements"."notification" (
    ...
    "type" notification_type not null default 'other'::notification_type,
    "user_id" uuid,
...
alter table "engagements"."response" add column "id" uuid not null default gen_random_uuid();

CREATE UNIQUE INDEX limit_user_to_one_response ON engagements.response USING btree (user_id, survey_id);

CREATE UNIQUE INDEX notification_pkey ON engagements.notification USING btree (id);

CREATE UNIQUE INDEX response_pkey ON engagements.response USING btree (id);

alter table "engagements"."notification" add constraint "notification_pkey" PRIMARY KEY using index "notification_pkey";

alter table "engagements"."response" add constraint "response_pkey" PRIMARY KEY using index "response_pkey";

alter table "engagements"."notification" add constraint "notification_user_id_fkey" FOREIGN KEY (user_id) REFERENCES profile(user_id) ON DELETE CASCADE not valid;

alter table "engagements"."notification" validate constraint "notification_user_id_fkey";

alter table "engagements"."response" add constraint "limit_user_to_one_response" UNIQUE using index "limit_user_to_one_response";
...
grant delete on table "engagements"."notification" to "anon";

grant insert on table "engagements"."notification" to "anon";

grant references on table "engagements"."notification" to "anon";

grant select on table "engagements"."notification" to "anon";

grant trigger on table "engagements"."notification" to "anon";

grant truncate on table "engagements"."notification" to "anon";

grant update on table "engagements"."notification" to "anon";

grant delete on table "engagements"."notification" to "authenticated";

grant insert on table "engagements"."notification" to "authenticated";

grant references on table "engagements"."notification" to "authenticated";

grant select on table "engagements"."notification" to "authenticated";

grant trigger on table "engagements"."notification" to "authenticated";

grant truncate on table "engagements"."notification" to "authenticated";

grant update on table "engagements"."notification" to "authenticated";

grant delete on table "engagements"."notification" to "service_role";

grant insert on table "engagements"."notification" to "service_role";

grant references on table "engagements"."notification" to "service_role";

grant select on table "engagements"."notification" to "service_role";

grant trigger on table "engagements"."notification" to "service_role";

grant truncate on table "engagements"."notification" to "service_role";

grant update on table "engagements"."notification" to "service_role";

create policy "Enable access for authenticated users only"
on "engagements"."notification"
as permissive
for all
to authenticated
using (true)
...
CREATE TRIGGER send_order_update_notification_trigger AFTER INSERT ON engagements.notification FOR EACH ROW EXECUTE FUNCTION engagements.send_order_update_notification();

CREATE TRIGGER send_push_notification_trigger AFTER INSERT ON engagements.notification FOR EACH ROW EXECUTE FUNCTION engagements.send_push_notification_on_insert();


drop trigger if exists "update_wallet_balance_on_txn_confirmed_trigger" on "finances"."transaction";

drop policy "Enable access to Authenticated Users only" on "finances"."transaction";

drop policy "Enable access to Authenticated Users only" on "finances"."wallet_transaction";

alter table "finances"."wallet_transaction" drop constraint "wallet_transaction_transaction_id_fkey";

create table "finances"."profit_allocation" (
    "created_at" timestamp with time zone not null default now(),
    "cia" numeric not null default 0.00,
    "cwa" numeric not null default 0.00,
    "eia" numeric not null default 0.00,
    "crc" numeric not null default 0.00,
    "csa" numeric not null default 0.00,
    "daa" numeric not null default 0.00,
...
CREATE UNIQUE INDEX profit_allocation_pkey ON finances.profit_allocation USING btree (id);

alter table "finances"."profit_allocation" add constraint "profit_allocation_pkey" PRIMARY KEY using index "profit_allocation_pkey";

alter table "finances"."wallet_transaction" add constraint "wallet_transaction_transaction_id_fkey" FOREIGN KEY (transaction_id) REFERENCES finances.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "finances"."wallet_transaction" validate constraint "wallet_transaction_transaction_id_fkey";

set check_function_bodies = off;

CREATE OR REPLACE FUNCTION finances.on_unverified_prevent_wealth_wallet_txn_confirmations()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
BEGIN
...
CREATE OR REPLACE FUNCTION finances.search_transfer_beneficiary(query_str text, wallet_type text)
 RETURNS TABLE(description text, full_name text, corp_name text, wallet_id integer)
 LANGUAGE plpgsql
AS $function$
BEGIN
    RETURN QUERY
...
BEGIN
    ...
    IF _vested = true THEN
         update transaction set vested = true, confirmed_at = NOW()
...
grant delete on table "finances"."profit_allocation" to "anon";

grant insert on table "finances"."profit_allocation" to "anon";

grant references on table "finances"."profit_allocation" to "anon";

grant select on table "finances"."profit_allocation" to "anon";

grant trigger on table "finances"."profit_allocation" to "anon";

grant truncate on table "finances"."profit_allocation" to "anon";

grant update on table "finances"."profit_allocation" to "anon";

grant delete on table "finances"."profit_allocation" to "authenticated";

grant insert on table "finances"."profit_allocation" to "authenticated";

grant references on table "finances"."profit_allocation" to "authenticated";

grant select on table "finances"."profit_allocation" to "authenticated";

grant trigger on table "finances"."profit_allocation" to "authenticated";

grant truncate on table "finances"."profit_allocation" to "authenticated";

grant update on table "finances"."profit_allocation" to "authenticated";

grant delete on table "finances"."profit_allocation" to "service_role";

grant insert on table "finances"."profit_allocation" to "service_role";

grant references on table "finances"."profit_allocation" to "service_role";

grant select on table "finances"."profit_allocation" to "service_role";

grant trigger on table "finances"."profit_allocation" to "service_role";

grant truncate on table "finances"."profit_allocation" to "service_role";

grant update on table "finances"."profit_allocation" to "service_role";

create policy "Enable access for authenticated users only"
on "finances"."profit_allocation"
as permissive
for all
to authenticated
using (true)
...
create policy "Enable access to Authenticated Users only"
on "finances"."wallet_transaction"
as permissive
for all
to authenticated
using (true)
...
CREATE TRIGGER on_unverified_prevent_wealth_wallet_txn_confirmations_trigger BEFORE INSERT OR UPDATE ON finances.transaction FOR EACH ROW EXECUTE FUNCTION finances.on_unverified_prevent_wealth_wallet_txn_confirmations();

CREATE TRIGGER update_wallet_balance_on_txn_confirmed_trigger AFTER UPDATE ON finances.transaction FOR EACH ROW EXECUTE FUNCTION finances.update_wallet_balance_on_txn_confirmed();


drop trigger if exists "check_if_referral_is_complete_trigger" on "geolocations"."address";

drop trigger if exists "verify_addres_trigger" on "geolocations"."address";
...
CREATE TRIGGER check_and_update_verification_trigger AFTER INSERT OR UPDATE ON geolocations.address FOR EACH ROW EXECUTE FUNCTION check_and_update_verification();

CREATE TRIGGER verify_address_trigger BEFORE INSERT OR UPDATE ON geolocations.address FOR EACH ROW EXECUTE FUNCTION geolocations.verify_address();
...
drop trigger if exists "send_push_notification_trigger" on "public"."notification";

drop trigger if exists "check_if_referral_is_complete_trigger" on "public"."profile";

drop policy "Enable access for authenticated users only" on "public"."notification";
...
alter table "public"."referral" drop constraint "referral_transaction_id_fkey";
...
alter table "public"."profile" add column "is_verified" boolean not null default false;
...
alter table "public"."referral" add constraint "referral_transaction_id_fkey" FOREIGN KEY (transaction_id) REFERENCES finances.transaction(id) ON DELETE CASCADE not valid;

alter table "public"."referral" validate constraint "referral_transaction_id_fkey";
...
CREATE OR REPLACE FUNCTION public.on_profile_verified_update_confirm_wealth_txns()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
CREATE TRIGGER check_and_update_verification_trgigger AFTER UPDATE ON public.profile FOR EACH ROW EXECUTE FUNCTION check_and_update_verification();

CREATE TRIGGER on_profile_verified_complete_referral_trigger AFTER UPDATE ON public.profile FOR EACH ROW EXECUTE FUNCTION on_profile_verified_complete_referral();

CREATE TRIGGER on_profile_verified_update_confirm_wealth_txns_trigger AFTER UPDATE ON public.profile FOR EACH ROW EXECUTE FUNCTION on_profile_verified_update_confirm_wealth_txns();




create type "sales"."ticket_resolution_type" as enum ('Reorder', 'Refund');

alter table "sales"."order" drop constraint "order_eesupreneur_id_fkey";

alter table "sales"."order_transaction" drop constraint "order_transaction_transaction_id_fkey";

drop function if exists "sales"."get_customer_orders"(_user_id uuid, _eesupreneur_id uuid, _eesupool_ord_id integer, _status sales.order_status);

drop function if exists "sales"."get_order_products"(ord_id integer);
...
alter table "sales"."order_product" add column "customer_accepted_qty" integer not null default 0;

alter table "sales"."order_product" add column "eesupreneur_accepted_qty" integer not null default 0;

CREATE UNIQUE INDEX order_ticket_pkey ON sales.order_ticket USING btree (id);

alter table "sales"."order_ticket" add constraint "order_ticket_pkey" PRIMARY KEY using index "order_ticket_pkey";

alter table "sales"."order_ticket" add constraint "order_ticket_order_id_fkey" FOREIGN KEY (order_id) REFERENCES sales."order"(id) ON DELETE CASCADE not valid;

alter table "sales"."order_ticket" validate constraint "order_ticket_order_id_fkey";

alter table "sales"."order" add constraint "order_eesupreneur_id_fkey" FOREIGN KEY (eesupreneur_id) REFERENCES services.eesupreneur(id) ON DELETE CASCADE not valid;

alter table "sales"."order" validate constraint "order_eesupreneur_id_fkey";

alter table "sales"."order_transaction" add constraint "order_transaction_transaction_id_fkey" FOREIGN KEY (transaction_id) REFERENCES finances.transaction(id) ON UPDATE CASCADE ON DELETE CASCADE not valid;

alter table "sales"."order_transaction" validate constraint "order_transaction_transaction_id_fkey";
...
BEGIN
    ...
    WHERE r.refereed_user_id = NEW.customer_id AND r.is_completed = TRUE AND w.type = 'income';
...
CREATE OR REPLACE FUNCTION sales.get_order_summed_food_class_earnings(_order_id integer)
 RETURNS TABLE(cia_total numeric, cwa_total numeric, eia_total numeric, crc_total numeric, csa_total numeric, daa_total numeric)
 LANGUAGE plpgsql
AS $function$
begin
RETURN QUERY SELECT
...
CREATE OR REPLACE FUNCTION sales.handle_crowd_fund_voucher_on_order_placed()
 RETURNS trigger
 LANGUAGE plpgsql
AS $function$
DECLARE
...
begin
    ...
    INSERT INTO sales.order_product (product_id, order_id, quantity, price,customer_accepted_qty, eesupreneur_accepted_qty)
    SELECT product_id, _order_id, quantity, price,quantity, quantity FROM inserted_products;
end; $function$
;
...
grant delete on table "sales"."order_ticket" to "anon";

grant insert on table "sales"."order_ticket" to "anon";

grant references on table "sales"."order_ticket" to "anon";

grant select on table "sales"."order_ticket" to "anon";

grant trigger on table "sales"."order_ticket" to "anon";

grant truncate on table "sales"."order_ticket" to "anon";

grant update on table "sales"."order_ticket" to "anon";

grant delete on table "sales"."order_ticket" to "authenticated";

grant insert on table "sales"."order_ticket" to "authenticated";

grant references on table "sales"."order_ticket" to "authenticated";

grant select on table "sales"."order_ticket" to "authenticated";

grant trigger on table "sales"."order_ticket" to "authenticated";

grant truncate on table "sales"."order_ticket" to "authenticated";

grant update on table "sales"."order_ticket" to "authenticated";

grant delete on table "sales"."order_ticket" to "service_role";

grant insert on table "sales"."order_ticket" to "service_role";

grant references on table "sales"."order_ticket" to "service_role";

grant select on table "sales"."order_ticket" to "service_role";

grant trigger on table "sales"."order_ticket" to "service_role";

grant truncate on table "sales"."order_ticket" to "service_role";

grant update on table "sales"."order_ticket" to "service_role";

create policy "Enable for authenticated users only"
on "sales"."order_ticket"
as permissive
for all
to authenticated
using (true)
...
CREATE TRIGGER allocate_profit_earnings_for_eesupool_member_orders_trigger AFTER UPDATE ON sales."order" FOR EACH ROW EXECUTE FUNCTION sales.allocate_profit_earnings_for_eesupool_member_orders();

CREATE TRIGGER allocate_profit_earnings_for_eesupreneur_orders_trigger AFTER UPDATE ON sales."order" FOR EACH ROW EXECUTE FUNCTION sales.allocate_profit_earnings_for_eesupreneur_orders();

CREATE TRIGGER handle_crowd_fund_voucher_on_order_placed_trigger AFTER UPDATE ON sales."order" FOR EACH ROW EXECUTE FUNCTION sales.handle_crowd_fund_voucher_on_order_placed();

CREATE TRIGGER set_default_order_assignment_trigger AFTER INSERT ON sales."order" FOR EACH ROW EXECUTE FUNCTION communities.set_default_order_assignment();

CREATE TRIGGER update_product_allocations_on_new_order_product_trigger BEFORE INSERT ON sales.order_product FOR EACH ROW EXECUTE FUNCTION sales.update_product_allocations_on_new_order_product();


alter table "services"."partner_application" drop constraint "partner_application_partner_id_fkey";

alter table "services"."eesupreneur" alter column "address_id" drop not null;

alter table "services"."eesupreneur" alter column "is_active" set default true;

alter table "services"."partner" add column "roles" user_role[] not null;

alter table "services"."partner" alter column "id" drop default;

alter table "services"."partner" alter column "id" set data type text using "id"::text;

alter table "services"."partner_application" add column "rejected_at" timestamp with time zone;

alter table "services"."partner_application" alter column "partner_id" set data type text using "partner_id"::text;

alter table "services"."partner_application" add constraint "partner_application_partner_id_fkey" FOREIGN KEY (partner_id) REFERENCES services.partner(id) ON DELETE RESTRICT not valid;

alter table "services"."partner_application" validate constraint "partner_application_partner_id_fkey";
...
CREATE TRIGGER prevent_editing_of_the_partner_id_value_trigger BEFORE UPDATE ON services.partner FOR EACH ROW EXECUTE FUNCTION services.prevent_editing_of_the_partner_id_value();

CREATE TRIGGER notify_applicant_on_application_update_trigger AFTER UPDATE ON services.partner_application FOR EACH STATEMENT EXECUTE FUNCTION services.notify_applicant_on_application_update();

CREATE TRIGGER on_partner_application_approved_trigger AFTER INSERT OR UPDATE ON services.partner_application FOR EACH ROW EXECUTE FUNCTION services.on_partner_application_approved();
