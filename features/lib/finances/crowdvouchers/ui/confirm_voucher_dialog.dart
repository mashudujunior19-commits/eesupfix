...
import 'package:features/finances/crowdvouchers/bloc/create_voucher_bloc.dart';
import 'package:features/finances/crowdvouchers/bloc/parameter_bloc.dart';
...
Future<Object?> confirmVoucherParameterDialog(
  ...
  return showAnimatedDialog(
    ...
    builder: (BuildContext context) {
      return _ConfirmVoucherParameter(voucher: voucher);
    },
...
class _ConfirmVoucherParameter extends StatelessWidget {
  _ConfirmVoucherParameter({required this.voucher});
