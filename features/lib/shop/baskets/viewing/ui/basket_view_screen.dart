...
import 'package:features/shop/baskets/viewing/ui/add_products_dialog.dart';
...
// final _basketProductsProvider =
//     FutureProvider.family<List<BasketProduct>, String>((ref, id) async {
//   final repo = ref.read(shoppingRepoProvider);
//   final result = await repo.fetchBasketProducts(id);
...
@RoutePage()
class BasketViewScreen extends StatefulWidget {
  const BasketViewScreen({super.key, required this.basket});
  static const route = '/basket-view-screen';
  final Basket basket;

  @override
  State<BasketViewScreen> createState() => _BasketViewScreenState();
}

class _BasketViewScreenState extends State<BasketViewScreen> {
        ...
        appBar: AppBar(
          ...
          title: Transform.scale(
            ...
            child: EESUpTextFormField(
              ...
              initialValue: widget.basket.name,
              readOnly: widget.basket.type != null,
              suffixIcon: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  if (widget.basket.type != null)
      ...
      child: Row(
        ...
        children: [
          TextButton(
            ...
            onPressed: () {
              addBasketProductsDialog(context, widget.basket.id)
                  .whenComplete(() {
  ...
  Widget build(BuildContext context) {
    ...
    return Dismissible(
      ...
      onDismissed: (direction) {
        ...
        //         basketProduct.basketId, basketProduct.productId)
        //     .whenComplete(() {
        //   ref.invalidate(
        //     _basketProductsProvider(basketProduct.basketId),
        //   );
        // });
      },
      background: Row(
                    ...
                    children: [
                      IconButton(
                        onPressed: () {
                          ...
                          // ref
                          //     .read(shoppingRepoProvider)
                          //     .removeProductFromBasket(basketProduct.basketId,
                      ...
                      IconButton(
                        onPressed: () {
                          ...
                          // ref
                          //     .read(shoppingRepoProvider)
                          //     .addProductToBasket(basketProduct.basketId,
                          //         basketProduct.productId)
                          //     .whenComplete(() {
                          //   ref.invalidate(_basketProductsProvider(
